...
class GameScene: SKScene {
    ...
    //MARK: other overridden functions
...
//        print("Amount to move: \(amountToMove)")
    ...
    //MARK: Touch processing functions
...
//        SKAction.moveTo(x: -enemy.size.width/2, duration: 2.0)
        SKAction.move(by: CGVector(dx: -cameraRect.size.width - enemy.size.width/2,
                                   dy: 0.0), duration: 2.0)
...
//        enemy.removeFromParent()
    ...
    //MARK: Background and Camera Processing
